    ...
    return (
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          {Object.keys(player).length === 0 ? <p className="mt-6 text-xl leading-8 text-gray-600">No players found, if you want to join us <a className="font-bold hover:text-black" href={`/recruitment/games`}>apply here</a></p> : 
          <ul
          role="list"
        ...
        >
          ...
          {player.map((person) => (
            <li key={person.name}>
              {person.imgUrl != "" ?
              <img className="mx-auto h-48 w-48 rounded-full md:h-56 md:w-56" src={person.imgUrl} alt="" />
