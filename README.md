...
Next.js, Node v.20/Edge (contact doesn't work on edge) runtime, mongodb (the mongodb files/folder are unused in lib) with prisma layer, mainly Javascript with some typescript, tailwind
