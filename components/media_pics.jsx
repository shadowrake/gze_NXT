...
export default function Main_media({media}) {
    ...
    return (
        ...
        <div className="hidden md:block mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        ...
        <div className="md:hidden mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
            ...
            {/* thumbnails under the gallery */}
            <nav className={cn('my-10', !showNavigation )}>
                <ul className='flex mt-6 grid grid-cols-3 gap-x-8 gap-y-15 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-8'>
                    {media.map((media, index) => (
                    <li key={media.id}>
                        <button
                        onClick={() => {
                        ...
                        <img
                            src={media.imgUrl}
                            alt={media.imgAlt}
                            className='block mt-2 h-full w-full object-cover'
                        />
                        </button>
                    </li>
                    ))}
